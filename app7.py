...
navbar = dbc.Navbar(
    dbc.Container(
        [
            ...
            #             dbc.Col(dbc.NavbarBrand("One Min Python", className="ms-2")),
            #         ],
            #         align="center",
            #         className="g-0",
            #     ),
            ...
            dbc.Nav(
                [
                    dbc.Button(
                        ...
                        id="nav-login-button",
                        style={
                            'backgroundColor': '#4C566A',  # Nordic dark gray
                            'border': 'none',
                            'borderRadius': '6px',
                            'padding': '8px 20px',
                            'color': '#ECEFF4',  # Nordic snow white
                            'fontWeight': '500',
                            'fontSize': '0.95rem',
                            'letterSpacing': '0.3px',
    ...
    color="#ECEFF4",  # Nordic snow white background
    dark=False,
    className="mb-5",
    style={'boxShadow': '0 2px 4px rgba(76, 86, 106, 0.1)'}  # Subtle shadow
)
            ...
            html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        "width": "260px", "minHeight": "180px", "display": "flex", "flexDirection": "column",
                        "alignItems": "center", "justifyContent": "center", "background": "#f6f8fa",
                        "borderRadius": "18px", "boxShadow": "0 2px 8px rgba(0,0,0,0.04)", "margin": "0 16px"
                    }),
                    html.Div([
                        html.I(className="fas fa-database hero-feature-icon"),
                        html.H3("방대한 DB", className="hero-feature-title"),
                        html.P("Ecoinvent 등 국내외 다양한 DB 내장", className="hero-feature-desc")
                    ], className="hero-feature", style={
                        "width": "260px", "minHeight": "180px", "display": "flex", "flexDirection": "column",
                        "alignItems": "center", "justifyContent": "center", "background": "#f6f8fa",
                        "borderRadius": "18px", "boxShadow": "0 2px 8px rgba(0,0,0,0.04)", "margin": "0 16px"
                ...
                ], className="hero-features", style={"display": "flex", "justifyContent": "center", "gap": "16px"}),
            ], className="hero-content"),
        ], style={
            "position": "absolute",
            "top": "56px",  # navbar 높이에 맞게 조정
            "left": "0",
            "width": "100vw",
...
app.clientside_callback(
    """
    function(n_clicks) {
        if (!window.lightEffectInitialized) {
            window.lightEffectInitialized = true;
